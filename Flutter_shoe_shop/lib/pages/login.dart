...
import 'package:flutter_Shoe_shop/pages/forgotpassword.dart';
...
Widget build(BuildContext context) {
  return Scaffold(
    resizeToAvoidBottomInset: false, // Zapobiega automatycznemu przesuwaniu elementów przez klawiaturę
    body: SingleChildScrollView( // Dodanie SingleChildScrollView
      child: Container(
        height: MediaQuery.of(context).size.height, // Ustawienie wysokości na cały ekran
        child: Stack(
          children: [
            Container(
